<head>
    ...
    <!-- animate.css-->
    <link rel="stylesheet" href="{{asset('distribution/vendor/animate.css/animate.css')}}">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{asset('distribution/css/style.violet.css')}}" id="theme-stylesheet">
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="distribution/img/favicon.png">
