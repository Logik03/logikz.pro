    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 text-center text-lg-left">
                <p class="social"><a href="https://github.com/Graith-web" class="external github wow fadeInUp"><i class="fa fa-github" style="font-size:36px"></i></a><a href="#" data-wow-delay="0.2s" class="external instagram wow fadeInUp"><i class="fa fa-twitter-square"></i></a><a href="#" data-wow-delay="0.4s" class="external gplus wow fadeInUp"><i class="fa fa-google-plus"></i></a><a href="#" data-wow-delay="0.6s" class="email wow fadeInUp"><i class="fa fa-envelope"></i></a></p>
            </div>
            <!-- /.6-->
...
<script src="{{asset('distribution/vendor/jquery.counterup/jquery.counterup.js')}}"></script>
