...
function map() {
    ...
    /*var map = new GMaps({
        el: '#map',
        lat:  9.0819688,
        lng: 7.39208661531787
    });

    map.addMarker({
        lat: 9.0819688,
        lng: 7.39208661531787,
        title: 'No 59 Hillview Estate, Lifecamp FCT, Abuja'
    });
    ...
    var mapId = 'map',
        mapCenter = [9.0819688, 7.39208661531787],
        mapMarker = true;
    ...
    if ($('#' + mapId).length > 0) {
        ...
        var icon = L.icon({
            iconUrl: 'distribution/img/marker.png',
            iconSize: [25, 37.5],
            popupAnchor: [0, -18],
            tooltipAnchor: [0, 19]
        });
       ...
       var Stamen_TonerLite = L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}{r}.{ext}', {
        ...
        if (mapMarker) {
            ...
            marker.bindPopup("<div class='p-4'><h5>I am located at</h5><p>No 59, Hillview Estate Zone 1,Lifecamp FCT, Abuja.</p></div>", {
                minwidth: 200,
                maxWidth: 700,
